...
class Generate extends Base
{
    ...
    public function execute()
    {
        ...
        $testName = $rootNamespace . 'Test' . substr($srcClass, strlen($rootNamespace));
        ...
        $testFile = 'tests' . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . str_replace('\\', DIRECTORY_SEPARATOR, $testName) . 'Test.php';
